...
BLOG_AUTHOR = "Ramesh Sampath"  # (translatable)
BLOG_TITLE = "Ramesh Sampath"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://www.sampathweb.com/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.sampathweb.com"
BLOG_EMAIL = "ramesh@sampathweb.com"
BLOG_DESCRIPTION = "Ramesh Sampath - Thoughts and Experiments"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/stories/ramesh-sampath.html', 'About me', 'icon-user'),
        ('https://twitter.com/sampathweb', 'My Twitter', 'icon-twitter'),
        ('https://github.com/sampathweb', 'My Github', 'icon-github'),
    )
}
...
# Default is:
FILES_FOLDERS = {'files': 'data', 'games': 'games'}
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date} <a href="mailto:{email}">{author}</a> - Powered by <a href="http://getnikola.com" rel="nofollow" target="_blank">Nikola</a> - Zen theme by <a href="https://github.com/damianavila" rel="nofollow" target="_blank">Damián Avila</a>         {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "sampathweb-blog"
